...
If you've found a bug, or would like to make a feature request, head to the [GitHub Repo](https://github.com/verbb/social-poster/issues) and file an issue. Pull requests are also most welcome!
...
Ask a question via the [Craft Stack Exchange](http://craftcms.stackexchange.com/) and tag your question with `plugin-social-poster`.
